...
# result_table = pd.DataFrame(columns=['Model', 'Target', 'Class', 'Precision', 'Recall', 'F1-Score', 'Accuracy', 'AUC'])
# summary_table = pd.DataFrame(columns=['Model', 'Target', 'Micro F1', 'Macro F1', 'Weighted F1'])
